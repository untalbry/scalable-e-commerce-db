CREATE TABLE IF NOT EXISTS "ec01_users" (
	...
	"st_email_verified" BOOLEAN NOT NULL DEFAULT FALSE,
	PRIMARY KEY("id_user")
);
...
CREATE TABLE IF NOT EXISTS "ec06_user_tokens" (
	"id_user_token" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"fk_id_user" INTEGER NOT NULL,
	"tx_token" VARCHAR(6) NOT NULL,
